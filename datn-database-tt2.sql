...
/*in chi tiet hoa don*/
select hdb.MaHDBan as 'Mã Hoá Đơn', TenSach as 'Sách', s.DonGia as 'Đơn giá', cthdb.Sluong as 'Số lượng', DonGia * cthdb.Sluong as 'Tổng tiền'
from HoaDonBan hdb join CTHoaDonBan cthdb on hdb.MaHDBan = cthdb.MaHDBan
				   join Sach s on cthdb.MaSach = s.MaSach
group by hdb.MaHDBan, cthdb.GiaTien, cthdb.Sluong, TenSach, DonGia
