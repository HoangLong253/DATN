                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mt-5 mb-3 clearfix">
                                    ...
                                    <a href="./functions/emp_add.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Thêm</a>
                                </div>
                                <?php
                    // Include config file
                                        ...
                                        echo "<td>";
                                            ?>
                                                ...
                                                <form action="./functions/del_func.php" method="POST">
                                                    <button id="del_btn" class="fa fa-trash" name="emp_del" value="<?=$row['MaNV'];?>">
